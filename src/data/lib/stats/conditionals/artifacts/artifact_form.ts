...
export const ArtifactForm = () => {
  const content: IContent[] = [
    ...
    },
    {
      ...
      content: `Increases DMG against opponents affected by <b class="text-hsr-lightning">Electro</b> by <span class="text-desc">35%</span>.`,
      show: true,
      default: true,
      id: '1873342283',
    },
    {
      ...
      text: `Lavawalker`,
      title: `Lavawalker`,
      content: `Increases DMG against opponents affected by <b class="text-hsr-fire">Pyro</b> by <span class="text-desc">35%</span>.`,
      show: true,
      default: true,
      id: '1632377563',
    },
    ...
    },
    {
      ...
      content: `When a character attacks an opponent affected by <b class="text-hsr-ice">Cryo</b>, their CRIT Rate is increased by <span class="text-desc">20%</span>. If the opponent is <b class="text-hsr-ice">Frozen</b>, CRIT Rate is increased by an additional <span class="text-desc">20%</span>.`,
      show: true,
      default: 0,
      min: 0,
      max: 2,
    ...
    },
    {
      ...
      <br />When on the field, the character gains <span class="text-desc">1</span> stack after hitting an opponent with a <b class="text-hsr-quantum">Geo</b> attack, triggering a maximum of once every <span class="text-desc">0.3</span>s.
      <br />When off the field, the character gains <span class="text-desc">1</span> stack every <span class="text-desc">3</span>s.
      <br />Curiosity can stack up to <span class="text-desc">4</span> times, each providing <span class="text-desc">6%</span> DEF and a <span class="text-desc">6%</span> <b class="text-hsr-quantum">Geo DMG Bonus</b>.
    ...
    },
    {
      ...
      content: `After Elemental Skills or Bursts hit opponents, the targets' <b class="text-hsr-imaginary">Dendro RES</b> will be decreased by <span class="text-desc">30%</span> for <span class="text-desc">8</span>s. This effect can be triggered even if the equipping character is not on the field.`,
      show: true,
      default: true,
      id: '1675079283',
      debuff: true,
    ...
    },
    {
      ...
      text: `Nymph's Dream`,
      title: `Nymph's Dream`,
      content: `After Normal, Charged, and Plunging Attacks, Elemental Skills, and Elemental Bursts hit opponents, <span class="text-desc">1</span> stack of Mirrored Nymph will triggered, lasting 8s. When under the effect of <span class="text-desc">1</span>, <span class="text-desc">2</span>, or <span class="text-desc">3 or more</span> Mirrored Nymph stacks, ATK will be increased by <span class="text-desc">7%/16%/25%</span>, and <b class="text-gray">Hydro DMG</b> will be increased by <span class="text-desc">4%/9%/15%</span>. Mirrored Nymph created by Normal, Charged, and Plunging Attacks, Elemental Skills, and Elemental Bursts exist independently.`,
      show: true,
      default: 0,
      min: 0,
      max: 3,
