...
export const ArtifactForm = () => {
  const content: IContent[] = [
    ...
    },
    {
      ...
      content: `When the wearer enters combat or uses Skill, their Skill and Ultimate DMG dealt increases by <span class="text-desc">18%</span>, stacking up to <span class="text-desc">3</span> time(s). At the start of the wearer's turn or after using their Ultimate, removes <span class="text-desc">1</span> stack(s) of this effect.`,
      show: true,
      default: 1,
      min: 0,
      max: 3,
