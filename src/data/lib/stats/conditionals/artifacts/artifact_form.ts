...
export const ArtifactForm = () => {
  const content: IContent[] = [
    ...
    {
      type: 'number',
      text: `Navigator Set Stacks`,
      title: `Navigator Set Stacks`,
      content: `When the wearer enters combat or uses Skill, the DMG dealt by their Skill and Ultimate increases by <span class="text-desc">18%</span>, stacking up to <span class="text-desc">3</span> time(s). At the start of the wearer's turn or after using Ultimate, removes <span class="text-desc">1</span> stack(s) of this effect.`,
      show: true,
      default: 1,
      min: 0,
      max: 3,
    ...
    },
    {
      ...
      text: `Comburent`,
      title: `Comburent`,
      content: `The DMG dealt by ally targets with <b>Comburent</b> increases by <span class="text-desc">15%</span>.`,
      show: true,
      default: true,
      id: '132',
      excludeSummon: true,
