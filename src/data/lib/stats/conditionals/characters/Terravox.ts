...
const Terravox = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    ult: {
      ...
      <br /><b class="text-hsr-physical">Souldragon</b> becomes enhanced, and when <b class="text-hsr-physical">Souldragon</b> takes action, triggers a <u>Follow-up ATK</u> that deals DMG of the <b class="text-desc">Bondmate</b>'s Type equal to {{3}}% of the <b class="text-desc">Bondmate</b>'s ATK to all enemies. Enhancement lasts for <span class="text-desc">2</span> <b class="text-hsr-physical">Souldragon</b> action(s).`,
      value: [
    ...
    talent: {
      ...
      value: [
        { base: 10, growth: 0.625, style: 'heal' },
    ...
    a4: {
      ...
      title: `Sylvanity`,
      content: `When the battle begins, advances Dan Heng • Permansor Terrae's action by <span class="text-desc">40%</span>.`,
    },
    a6: {
      trace: 'Ascension 6 Passive',
      title: `Sublimity`,
      content: `When <b class="text-desc">Bondmate</b> uses an attack, Dan Heng • Permansor Terrae regenerates <span class="text-desc">5</span> Energy and advances <b class="text-hsr-physical">Souldragon</b>'s action by <span class="text-desc">15%</span>.`,
    },
    c1: {
      trace: 'Eidolon 1',
      title: `Shed Scales of Old`,
      content: `When Dan Heng • Permansor Terrae uses his Ultimate, recovers <span class="text-desc">1</span> Skill Point(s) for the team and increases the <b class="text-desc">Bondmate</b>'s <b>All-Type RES PEN</b> by <span class="text-desc">15%</span> for <span class="text-desc">3</span> turn(s).`,
    },
    c2: {
      trace: 'Eidolon 2',
      title: `Watch Trails to Blaze`,
      content: `Additionally increases the number of Ultimate enhancements by <span class="text-desc">2</span> time(s). After Dan Heng • Permansor Terrae uses Ultimate, <b class="text-hsr-physical">Souldragon</b>'s action advances by <span class="text-desc">100%</span>. When the enhanced <b class="text-hsr-physical">Souldragon</b> takes action, its DMG multiplier increases by a value equal to <span class="text-desc">80%</span> of the <b class="text-desc">Bondmate</b>'s ATK, and additionally deals DMG of the corresponding Type equal to <span class="text-desc">80%</span> of <b class="text-desc">Bondmate</b>'s ATK to the enemy unit with the highest current HP.`,
    },
    c3: {
      trace: 'Eidolon 3',
    ...
    c4: {
      ...
      content: `When the target chosen as <b class="text-desc">Bondmate</b> deals DMG, ignores <span class="text-desc">12%</span> of the enemy target's DEF.`,
    },
    c5: {
      trace: 'Eidolon 5',
    ...
    c6: {
      ...
      content: `When there is a <b class="text-desc">Bondmate</b> on the field, increases the DMG received by all enemies by <span class="text-desc">20%</span>. When Dan Heng • Permansor Terrae uses his Ultimate, the <b class="text-desc">Bondmate</b> will deal DMG of their corresponding Type to all enemies equal to <span class="text-desc">330%</span> of <b class="text-desc">Bondmate</b>'s ATK. This instance of DMG dealt by the <b class="text-desc">Bondmate</b> is considered as 1 attack.`,
    },
  }
  ...
  return {
    ...
    preCompute: (
      ...
      base.ULT_SCALING = [
        ...
        {
          name: 'Cast Shield',
          value: [{ scaling: calcScaling(0.2, 0.0125, ult, 'heal'), multiplier: Stats.ATK }],
      ...
      base.TALENT_SCALING = [
        {
          ...
          value: [{ scaling: calcScaling(0.1, 0.00625, talent, 'heal'), multiplier: Stats.ATK }],
        ...
        _.forEach(a, (x, i) => {
          if (allForm[i].bondmate) {
            ...
            base.ULT_SCALING.push({
              name: `Souldragon Follow-up ATK (${x.NAME})`,
              value: [
                {
                  scaling: calcScaling(0.4, 0.04, ult, 'curved') + (c >= 2 ? 0.8 : 0),
            ...
            if (c >= 2) {
              base.ULT_SCALING.push({
                name: `E2 Souldragon Follow-up ATK (${x.NAME})`,
                value: [{ scaling: 0.8, multiplier: Stats.ATK, override: x.getAtk() }],
                element: x.ELEMENT,
                property: TalentProperty.FUA,
                type: TalentType.NONE,
              })
