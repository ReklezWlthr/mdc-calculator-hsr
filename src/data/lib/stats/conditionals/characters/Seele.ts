...
const Seele = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    c6: {
      ...
      content: `After Seele uses her Ultimate, inflict the target enemy with <b class="text-hsr-quantum">Butterfly Flurry</b> for <span class="text-desc">1</span> turn(s). Enemies suffering from <b class="text-hsr-quantum">Butterfly Flurry</b> will take <b class="text-hsr-quantum">Supplemental Quantum DMG</b> equal to <span class="text-desc">15%</span> of Seele's Ultimate DMG every time they are attacked. If the target enemy is defeated by the <b class="text-hsr-quantum">Butterfly Flurry</b> DMG triggered by other allies' attacks, Seele's Talent will not be triggered.
