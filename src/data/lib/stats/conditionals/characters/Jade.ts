...
const Jade = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />After the <b>Debt Collector</b> attacks, deals <span class="text-desc">1</span> instance of <b class="text-hsr-quantum">Supplemental Quantum DMG</b> equal to {{0}}% of Jade's ATK to each enemy target hit, and consumes the Debt Collector's HP by an amount equal to <span class="text-desc">2%</span> of their Max HP. If the current HP is insufficient, reduces HP to <span class="text-desc">1</span>.
