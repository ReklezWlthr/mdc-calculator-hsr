...
const FireflyBase = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    a6: {
      ...
      content: `For every <span class="text-desc">10</span> point(s) of SAM's ATK that exceeds <span class="text-desc">1800</span>, increases this unit's Break Effect by <span class="text-desc">0.8%</span>.`,
    },
    a4: {
