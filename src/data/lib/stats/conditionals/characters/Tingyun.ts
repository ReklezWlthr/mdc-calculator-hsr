...
const Tingyun = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      content: `Grants one designated Party character <b>Benediction</b>, increasing their ATK by {{0}}%, up to {{1}}% of Tingyun's current ATK.
      <br />After the character with <b>Benediction</b> uses an attack, additionally deals <span class="text-desc">1</span> instance of <b class="text-hsr-lightning">Lightning Supplemental DMG</b> equal to {{2}}% of that characters's ATK.
    ...
    ult: {
      ...
      content: `Regenerates <span class="text-desc">50</span> Energy for one designated Party character and increases their DMG dealt by {{0}}% for <span class="text-desc">2</span> turn(s).`,
    ...
    c1: {
      ...
      content: `After one Party character with <b>Benediction</b> uses their Ultimate, increases their SPD by <span class="text-desc">20%</span> for <span class="text-desc">1</span> turn.`,
    },
    c2: {
      trace: 'Eidolon 2',
      title: `Gainfully Gives, Givingly Gains`,
      content: `When one Party character with <b>Benediction</b> defeats any Enemy target, regenerates their Energy by <span class="text-desc">5</span>. This effect can only trigger once per turn.`,
    },
    c3: {
      trace: 'Eidolon 3',
    ...
    c6: {
      ...
      content: `Ultimate regenerates <span class="text-desc">10</span> more Energy for Party characters.`,
    },
  }
          ...
          if (allForm[i].tingyun_skill) {
            _.forEach(
              ...
              (s) => {
                if (_.some(s, (item) => _.includes([TalentProperty.NORMAL, TalentProperty.FUA], item.property)))
                  s.push({
                    name: `Benediction's Supplemental DMG`,
                    value: [
            ...
            if (i !== index)
              team[index].TALENT_SCALING.push({
                name: `${names[i]}'s Supplemental DMG`,
