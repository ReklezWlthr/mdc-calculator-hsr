...
const SilverWolf = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      trace: 'Skill',
      title: 'Allow Changes?',
      content: `There is a {{0}}% <u>base chance</u> to add <span class="text-desc">1</span> Weakness of an on-field ally target's Type to one designated enemy target (prioritizing the implant of a Weakness that matches the first character in the team lineup). This also reduces the enemy target's RES to that Weakness Type by <span class="text-desc">20%</span> for <span class="text-desc">3</span> turn(s). If the enemy target already has that Type Weakness, the RES reduction effect to that Type will not be triggered.
      <br />Each enemy can only have <span class="text-desc">1</span> Weakness implanted by Silver Wolf. When Silver Wolf implants another Weakness to the target, only the most recent implanted Weakness will be retained.
    ...
    ult: {
      ...
      trace: 'Ultimate',
      title: 'User Banned',
      content: `Has a {{0}}% <u>base chance</u> to reduce the DEF of all enemies by {{1}}% for <span class="text-desc">3</span> turn(s). At the same time, deals <b class="text-hsr-quantum">Quantum DMG</b> equal to {{2}}% of Silver Wolf's ATK to all enemies.`,
      value: [
        { base: 80, growth: 4, style: 'curved' },
    ...
    talent: {
      ...
      <br />When the enemy target gets defeated, the Weakness Silver Wolf implanted on it will be transferred to another surviving enemy on the field that hasn't been implanted with Weakness by Silver Wolf, prioritizing targets at Elite-level and above.`,
      value: [
    ...
    technique: {
      ...
      content: `Immediately attacks the enemy. After entering combat, deals <b class="text-hsr-quantum">Quantum DMG</b> equal to <span class="text-desc">80%</span> of Silver Wolf's ATK to all enemies, and reduces Toughness of all enemies regardless of Weakness Types. Enemies with their Weakness Broken in this way will trigger the <b class="text-hsr-quantum">Quantum</b> Weakness Break effect.`,
    },
    a2: {
      trace: 'Ascension 2 Passive',
      title: 'Generate',
      content: `The duration of Bug is extended for <span class="text-desc">1</span> turn(s). Every time an enemy's Weakness gets broken, Silver Wolf has a <span class="text-desc">100%</span> <u>base chance</u> of implanting <span class="text-desc">1</span> random Bug on that target.`,
    },
    a4: {
      trace: 'Ascension 4 Passive',
      title: 'Inject',
      content: `When the battle starts, immediately regenerates <span class="text-desc">20</span> Energy. When Silver Wolf's turn starts, she regenerates <span class="text-desc">5</span> Energy.`,
    },
    a6: {
      trace: 'Ascension 6 Passive',
      title: 'Side Note',
      content: `For every <span class="text-desc">10%</span> Effect Hit Rate that Silver Wolf has, additionally increases her ATK by <span class="text-desc">10%</span>, up to a max of <span class="text-desc">50%</span>.`,
    },
    c1: {
      trace: 'Eidolon 1',
      title: 'Social Engineering',
      content: `After using Ultimate to attack an enemy target, Silver Wolf regenerates <span class="text-desc">7</span> Energy for every debuff on the target. This effect can trigger up to <span class="text-desc">5</span> time(s) in each use of her Ultimate.`,
    },
    c2: {
      trace: 'Eidolon 2',
      title: 'Zombie Network',
      content: `When an enemy target enters battle, increases their DMG taken by <span class="text-desc">20%</span>. When an enemy target gets attacked by ally targets, Silver Wolf has a <span class="text-desc">100%</span> <u>base chance</u> to implant <span class="text-desc">1</span> random Bug on the attacked enemy target.`,
    },
    c3: {
      trace: 'Eidolon 3',
      title: 'Payload',
    ...
    c4: {
      trace: 'Eidolon 4',
      title: 'Bounce Attack',
      content: `After using Ultimate to attack an enemy target, deals <b class="text-hsr-quantum">Quantum Additional DMG</b> equal to <span class="text-desc">20%</span> of Silver Wolf's ATK for every debuff on the target. This effect can trigger up to <span class="text-desc">5</span> time(s) per target during each use of Ultimate.`,
    },
    c5: {
      trace: 'Eidolon 5',
    ...
    c6: {
      ...
      content: `For every debuff the enemy target has, the DMG dealt by Silver Wolf to it increases by <span class="text-desc">20%</span>, up to a max increase of <span class="text-desc">100%</span>.`,
    },
  }
