...
const Gepard = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />While <b class="text-hsr-ice">Frozen</b>, the enemy cannot take action and will take <b class="text-hsr-ice">Supplemental Ice DMG</b> equal to {{1}}% of Gepard's ATK at the beginning of each turn.`,
      value: [
