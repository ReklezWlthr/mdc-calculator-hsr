...
const AventurineSP = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    talent: {
      ...
      <br />When <b class="text-green-300">Fervor</b> reaches <span class="text-desc">10</span> points, Aventurine • Waveflair uses <b>Cheers! To Summer's Blaze</b> <span class="text-desc">1</span> time, which takes a fixed <span class="text-desc">20</span> <b class="text-orange-400">Punchline(s)</b> into account. After this use, the next Elation Skill used by this unit in the Aha Instant is enhanced into <b>All In! To Summer's Blaze</b>.
