...
const Castorice = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    skill: {
      ...
      <br />If <b>Deathwing</b> is on the battlefield, this Skill becomes <b>Boneclaw, Doomdrake's Embrace</b> instead.`,
      value: [
    ...
    summon_skill: {
      ...
      <br />Consumes HP equal to <span class="text-desc">25%</span> of <b>Deathwing</b>'s max HP and deals <b class="text-hsr-quantum">Quantum DMG</b> to all enemies equal to {{0}}%/{{1}}%/{{2}}% of Castorice's Max HP. When HP is insufficient, it will drop to a limit of <span class="text-desc">1</span> and using this ability will not end the turn.
      <br />Using this ability repeatedly will enhance it, lasting until the <b>Deathwing</b> disappears.
      <br />When HP is less than or equal to <span class="text-desc">25%</span>, using this ability will actively trigger the Talent ability effect of <b>Wings Sweep the Ruins</b>.`,
      value: [
    ...
    ult: {
      ...
      content: `Summons the memosprite <b>Deathwing</b> and <u>advances its action</u> by <span class="text-desc">100%</span>. At the same time, creates the Territory <b>Lost Netherland</b>, which decreases all enemies' <b>All-Type RES</b> by {{0}}%. If the DMG Boost effect from Castorice's Talent is active, the effect is extended to <b>Deathwing</b>. <b>Deathwing</b> has <span class="text-desc">140</span> SPD and a set Max HP equal to <span class="text-desc">100%</span> of max <b class="text-indigo-400">Newbud</b>.
      <br />After <b>Deathwing</b> acts <span class="text-desc">3</span> times or when its HP is <span class="text-desc">0</span>, it disappears and dispels the Territory <b>Lost Netherland</b>.`,
    ...
    unique_talent: {
      ...
      content: `After obtaining Castorice or when Castorice is in the current team, receive the following effect: In battle, when an ally character receives a killing blow, all allies that received a killing blow in this action enter the <b class="text-violet-400">Mooncocoon</b> state. Characters in <b class="text-violet-400">Mooncocoon</b> temporarily delay becoming downed and can take <span class="text-desc">1</span> action normally. After the action, if they receive healing or have a Shield before their next turn, <b class="text-violet-400">Mooncocoon</b> is removed. Otherwise, they will be downed immediately. This effect can be triggered <span class="text-desc">1</span> time per battle.`,
      value: [],
      level: talent,
    ...
    summon_talent: {
      ...
      content: `When the <b>Deathwing</b> disappears, deals <span class="text-desc">6</span> instance(s) of DMG, with every instance dealing <b class="text-hsr-quantum">Quantum DMG</b> equal to {{0}}% of Castorice's Max HP to one random enemy unit.`,
      value: [{ base: 25, growth: 5, style: 'linear' }],
      level: talent,
    ...
    summon_talent_2: {
      ...
      content: `When <b>Deathwing</b> is on the field, it acts as <u>backup</u> for allies. When allies take DMG, their current HP can be reduced to a minimum of <span class="text-desc">1</span>, after which <b>Deathwing</b> will bear the DMG received at <span class="text-desc">500%</span> of the original DMG until <b>Deathwing</b> disappears.`,
      value: [],
      level: talent,
      tag: AbilityTag.SUPPORT,
    },
    summon_talent_3: {
      ...
      content: `When <b>Deathwing</b> is summoned, increases DMG dealt by all allies by <span class="text-desc">10%</span> for <span class="text-desc">2</span> turn(s).`,
      value: [],
      level: talent,
      tag: AbilityTag.SUPPORT,
    },
    ...
    a4: {
      ...
      content: `While <b>Deathwing</b> is not on the field, <span class="text-desc">100%</span> of excess healing for each ally target will restore an equal amount of <b class="text-indigo-400">Newbud</b>. While <b>Deathwing</b> is on the field, the excess healing will restore an equal amount of HP for <b>Deathwing</b>. Each restoration cannot exceed <span class="text-desc">15%</span> of max <b class="text-indigo-400">Newbud</b>/<b>Deathwing</b>'s Max HP.`,
    },
    a6: {
      trace: 'Ascension 6 Passive',
      title: `Where The West Wind Dwells`,
      content: `When <b>Deathwing</b> disappears, restores HP for all allies equal to <span class="text-desc">10%</span> of Castorice's Max HP plus <span class="text-desc">250</span>.`,
    },
    c1: {
      trace: 'Eidolon 1',
