...
const Hook = (c: number, a: { a2: boolean; a4: boolean; a6: boolean }, t: ITalentLevel, team: ITeamChar[]) => {
  ...
  const talents: ITalent = {
    ...
    talent: {
      ...
      content: `When attacking a target afflicted with <b class="text-hsr-fire">Burn</b>, deals <b class="text-hsr-fire">Supplemental Fire DMG</b> equal to {{0}}% of Hook's ATK and regenerates <span class="text-desc">5</span> extra Energy.`,
