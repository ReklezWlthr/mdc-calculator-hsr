...
export const LightCones = [
  ...
  },
  {
    ...
    desc: {
      name: 'Conquer',
      detail: `Increases the wearer's ATK by {{0}}%. After using Ultimate, recovers <span class="text-desc">1</span> Skill Point(s). When the wearer uses their Skill on an ally character, increases DMG dealt by target's Skill by {{1}}% for <span class="text-desc">3</span> turn(s).`,
      properties: [
        { base: 64, growth: 16 },
        { base: 54, growth: 13.5 },
      ],
