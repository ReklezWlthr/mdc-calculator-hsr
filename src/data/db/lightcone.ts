...
export const LightCones = [
  ...
  },
  {
    ...
    desc: {
      name: 'Tempering',
      detail: `Increases the wearer's Max HP by {{0}}%. At the start of the wearer's turn, regenerates a fixed amount of <span class="text-desc">20</span> Energy. This effect can trigger <span class="text-desc">1</span> time each wave. After the wearer uses Skill to attack, inflicts the target with the <b>Purgatory</b> state, lasting for <span class="text-desc">2</span> turn(s). While in the <b>Purgatory</b> state, the target receives {{0}}% increased CRIT DMG and {{0}}% additionally increased CRIT DMG from the wearer.`,
  ...
  },
  {
    ...
    desc: {
      name: 'Sprout',
      detail: `Increases the wearer's CRIT Rate by {{0}}% and Skill DMG by {{1}}%. When any ally consumes a total of <span class="text-desc">4</span> or more Skill Points in a single turn, the wearer gains <b>Radiant Crown</b>, lasting for <span class="text-desc">3</span> turn(s). While the wearer has <b>Radiant Crown</b>, all allies' DMG ignores {{2}}% of the target's DEF, and the wearer's DMG additionally ignores {{3}}% of the target's DEF. Effects of the same type cannot stack.`,
      properties: [
        { base: 18, growth: 3 },
        { base: 36, growth: 6 },
        { base: 10, growth: 2 },
  ...
  },
  {
    ...
    desc: {
      name: 'At Will',
      detail: `Increases the wearer's ATK by {{0}}% and Energy Regeneration Rate by {{1}}%. When the wearer uses their Ultimate, increases the Ultimate DMG dealt by {{1}}% of the Energy consumed, up to {{2}}%. When the wearer enters combat or uses their Ultimate, the wearer gains <b>King's Entertainment</b>, lasting for <span class="text-desc">3</span> turn(s). While the wearer has <b>King's Entertainment</b>, increases all allies' CRIT DMG by {{3}}%. Effects of the same type cannot stack.`,
      properties: [
        { base: 18, growth: 3 },
        { base: 10, growth: 2.5 },
        { base: 60, growth: 15 },
