...
export const CharDetailModal = observer(
  ({ char, cId, buffToggled }: { char: ICharStore; cId: string; buffToggled: boolean }) => {
    const { charStore, toastStore, modalStore, settingStore } = useStore()

    const charData = findCharacter(cId)
    const buffed = _.includes(buffedList, cId) && !(settingStore.settings.liveOnly && charData.novaBeta)
      ...
      char
        ? {
            ...
            minor_traces: formatMinorTrace(
              buffed && buffToggled ? charData?.novaTrace || charData?.trace : charData?.trace,
              _.map(char?.minor_traces, 'toggled'),
              charData?.overwrite,
            ),
          }
        : {
    ...
    const maxedTrace = formatMinorTrace(
      buffed && buffToggled ? charData?.novaTrace || charData?.trace : charData?.trace,
      Array(10).fill(true),
      charData?.overwrite,
    )
    ...
    const onDelete = useCallback(() => {
      modalStore.openModal(
        <CommonModal
          ...
          onCancel={() => {
            modalStore.openModal(<CharDetailModal char={char} cId={cId} buffToggled={buffToggled} />)
          }}
        />,
      )
    }, [char, cId])
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <CheckboxInput
                    ...
                    onClick={() =>
                      setParams({ major_traces: { ...params.major_traces, a2: !params.major_traces?.a2 } })
                    }
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <CheckboxInput
                    ...
                    onClick={() =>
                      setParams({ major_traces: { ...params.major_traces, a4: !params.major_traces?.a4 } })
                    }
              ...
              <div className="flex flex-col items-center gap-3">
                ...
                <div className="flex gap-2">
                  ...
                  <CheckboxInput
                    ...
                    onClick={() =>
                      setParams({ major_traces: { ...params.major_traces, a6: !params.major_traces?.a6 } })
                    }
