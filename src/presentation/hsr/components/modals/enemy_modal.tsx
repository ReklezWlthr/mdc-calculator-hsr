...
export const EnemyModal = observer(
  ({ stats, compare, compareIndex }: { stats: StatsObject; compare?: boolean; compareIndex?: number }) => {
            ...
            <div className="flex gap-4">
                  ...
                  <Tooltip
                    ...
                    body={
                      <p className="font-normal">
                        ...
                        <br />
                        Currently, this value is only used to calculate <b className="text-hsr-physical">Bleed DMG</b>,
                        so in most cases, it will not affect the calculation. Additionally, most high-level bosses have
                        so much HP that the <b className="text-hsr-physical">Bleed DMG</b> will be capped out before the
                  ...
                  <Tooltip
                    ...
                    body={
                      <p className="font-normal">
                        ...
                        target has multiple of them (e.g. Sunday Boss). The target will sustain Break DMG every time a
                        Bar is depleted but will not go into Weakness Broken state until all of them are depleted. Every
              ...
              <div className="flex flex-col w-full gap-y-1">
                ...
                <div className="flex items-center gap-x-2">
                  ...
                  />
                  {+level >= 51 && (
                    <p className="text-xs font-normal">+{_.min([10, 0.4 * (+level - 50)]).toFixed(1)}%</p>
                  )}
                </div>
              </div>
            </div>
