              ...
              <div className="flex flex-col mb-5 text-sm rounded-lg bg-primary-darker h-fit">
                ...
                {!!_.size(mainComputed?.MEMO_SKILL_SCALING) && (
                  <>
                    ...
                    <ScalingWrapper
                      talent={
                        mainComputed?.MEMO_SKILL_ALT ? main?.talents?.summon_skill_alt : main?.talents?.summon_skill
                      }
                      icon={`SkillIcon_1${charData.id}_Servant${mainComputed?.MEMO_SKILL_ALT ? '02' : '01'}.png`}
                      element={charData.element}
                      level={
                        mainComputed.PATH === PathType.REMEMBRANCE ? char.talents?.memo_skill : char.talents?.skill
                      }
                      upgraded={
                ...
                {!!_.size(mainComputed?.MEMO_TALENT_SCALING) && (
                  <>
                    ...
                    <ScalingWrapper
                      ...
                      element={charData.element}
                      level={
                        mainComputed.PATH === PathType.REMEMBRANCE ? char.talents?.memo_talent : char.talents?.talent
                      }
                      upgraded={
          ...
          {tab === 'summon' && (
            <>
              ...
              <ConditionalBlock
                ...
                contents={_.filter(contents.artifact(selected), (item) => !item.excludeSummon)}
                memo
                selected={selected}
              />
