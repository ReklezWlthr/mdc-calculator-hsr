      ...
      <div className="flex w-full h-full gap-x-5">
        ...
        {selected ? (
          <>
            ...
            <div className="w-1/5 space-y-5">
              <RelicBlock piece={4} aId={selectedBuild?.artifacts?.[3]} canEdit={false} />
              <RelicBlock piece={1} aId={selectedBuild?.artifacts?.[0]} canEdit={false} />
            </div>
            <div className="w-1/5 space-y-5">
              <RelicBlock piece={2} aId={selectedBuild?.artifacts?.[1]} canEdit={false} />
              <RelicBlock piece={3} aId={selectedBuild?.artifacts?.[2]} canEdit={false} />
            </div>
          </>
        ) : (
