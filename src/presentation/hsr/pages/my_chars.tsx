...
import { findBaseLevel, findMaxLevel, formatIdIcon, getBaseStat } from '@src/core/utils/data_format'
import { AscensionOptions, EidolonOptions, Element, Stats, PathType } from '@src/domain/constant'
