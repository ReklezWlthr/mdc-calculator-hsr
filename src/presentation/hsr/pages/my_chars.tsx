...
export const MyCharacters = observer(() => {
  ...
  const FilterIcon = ({ type, value }: { type: 'element' | 'weapon'; value: Element | PathType }) => {
        ...
        <img
          src={
            type === 'element'
              ...
              : `https://enka.network/ui/hsr/${WeaponIcon[value]}`
          }
        />
      </div>
    )
  ...
  const charCond = _.find(conditionals, ['id', charData?.id])?.conditionals(
    ...
    charUpgrade?.talents || { basic: 1, skill: 1, ult: 1 },
  ...
  const {
    ...
    normal: charUpgrade?.talents?.basic || 1,
    skill: charUpgrade?.talents?.skill || 1,
    burst: charUpgrade?.talents?.ult || 1,
  })
      ...
      <div className="flex w-full h-full gap-x-10">
        <div className="flex flex-col w-1/3 h-full gap-y-2 shrink-0">
          ...
          <div className="flex items-center gap-6 my-1">
            ...
            <div className="flex gap-2">
              <FilterIcon type="weapon" value={PathType.SWORD} />
              <FilterIcon type="weapon" value={PathType.CLAYMORE} />
              <FilterIcon type="weapon" value={PathType.POLEARM} />
              <FilterIcon type="weapon" value={PathType.BOW} />
              <FilterIcon type="weapon" value={PathType.CATALYST} />
            </div>
          </div>
              ...
              return (
                ...
                >
                  <div className="relative">
                    ...
                    <img
                      src={`https://enka.network/ui/hsr/UI_AvatarIcon_${codeName}.png`}
        ...
        {selected ? (
          <div className="w-full h-full p-2 text-white hideScrollbar">
            <div className="flex w-full gap-2">
              ...
              <img
                src={`https://enka.network/ui/hsr/UI_Gacha_AvatarImg_${fCodeName}.png`}
                className={classNames(
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-0.5">
                      <div className="p-1 rounded-full w-14 h-14 bg-primary" title={charData?.weapon}>
                        <img src={`https://enka.network/ui/hsr/${WeaponIcon[charData?.weapon]}`} />
                      </div>
                    </div>
                    <div className="flex gap-0.5">
                    ...
                    <>
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <TalentIcon
                          ...
                          icon={`https://enka.network/ui/hsr${WeaponIcon[charData?.weapon]}`}
                          size="w-10 h-10"
                          tooltipSize="w-[520px]"
                          upgraded={charCond?.upgrade?.basic}
                          level={charUpgrade?.talents?.basic}
                        />
                        <TalentIcon
                        ...
                        <TalentIcon
                          ...
                          size="w-10 h-10"
                          tooltipSize="w-[550px]"
                          upgraded={charCond?.upgrade?.ult}
                          level={charUpgrade?.talents?.ult}
                        />
                      </div>
                    </>
                  )}
              ...
              <div className="flex flex-col text-sm gap-y-5">
                ...
                {charCond?.talents?.sprint && (
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <img
                        src={`https://enka.network/ui/hsr/Skill_S_${charData.codeName}_02.png`}
                        className={classNames(
                          'w-12 h-12 p-1 rounded-full bg-opacity-60 ring-2 ring-offset-2 hover:ring-offset-4 duration-200 ring-offset-primary-darker',
                          charUpgrade
                            ? ElementIconColor[charData?.element]
                ...
                {charData?.id === '10000054' && (
                  <div className="flex items-center gap-3">
                    ...
                    >
                      <img
                        src={`https://enka.network/ui/hsr/UI_Talent_S_Kokomi_07.png`}
                        className={classNames(
                          'w-12 h-12 p-1 rounded-full bg-opacity-60 ring-2 ring-offset-2 hover:ring-offset-4 duration-200 ring-offset-primary-darker',
                          ElementIconColor[charData?.element]
                        )}
